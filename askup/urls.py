...
urlpatterns = [
    ...
    url(r'^organization/update/(?P<pk>\d+)/$', views.organization_update, name='organization_update'),
    ...
    url(r'^question/answer/(?P<pk>\d+)/$', views.question_answer, name='question_answer'),
