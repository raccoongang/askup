...
function handleUserFeedback(t, e, n) {
    t && sendFeedback("/questions/" + n + "/feedback", e), "yes" == e && ($(".feedback-alert").removeClass("alert-danger alert-maybe").addClass("alert-success"), $(".feedback-alert-text").text("Got it!")), "no" == e && ($(".feedback-alert").removeClass("alert-success alert-maybe").addClass("alert-danger"), $(".feedback-alert-text").text("Missed it!")), "maybe" == e && ($(".feedback-alert").removeClass("alert-danger alert-success").addClass("alert-maybe"), $(".feedback-alert-text").text("Sort-of"))
}
...
function initUserFeedbackQuizAll() {
    $(".btn-feedback").unbind().click(function(t) {
        t.preventDefault();
        var e = $(t.target).closest(".btn-feedback"),
            n = e.data("feedback-active"),
            i = e.data("feedback-string"),
            o = quizQuestions[quizAllIndex].id;
        handleUserFeedback(n, i, o), quizQuestions.length > quizAllIndex + 1 ? (quizAllIndex++, $(".feedback-alert").slideDown(1e3, function() {
            initQuestionDisplayModalForQuizAll()
        }).delay(1e3).slideUp(800)) : ($(".feedback-alert").slideDown(1e3).delay(1e3).slideUp("slow", function() {
...
function initUserFeedbackQuestionShow() {
    $(".btn-feedback").unbind().click(function(t) {
        ...
        var e = $(t.target).closest(".btn-feedback"),
            n = e.data("feedback-active"),
            i = e.data("feedback-string"),
            o = e.data("feedback-qid");
        handleUserFeedback(n, i, o), $(".feedback-alert").slideDown(), $(".response").hide("slow")
    })
}

function initAnswerButton() {
    validateAnswer(), $(".answer-text").keyup(validateAnswer), $(".submit-answer").click(function(t) {
        t.preventDefault(), $(".answers, .response").fadeIn(), $(".submit-answer").hide("slow")
    })
}

function validateEditQuestionInput() {
    var t = $("#question_text").val().trim() && $("#question_answers_attributes_0_text").val().trim() && $("#qset-id-input").val().trim();
    $(".submit-question").attr("disabled", !t)
}

function initSocialModal(t, e) {
    var n = e.data("website"),
        i = e.data("question"),
        o = e.data("url"),
        r = e.data("hyperlink"),
        a = e.data("hyperlinktext");
    t.find(".modal-title").text(n), t.find(".modal-body-social input").val(i + " \u27a1Follow the link to find out the answer: " + o), t.find(".hyperlink").attr("href", r), t.find(".hyperlink").text(a)
}

function initEditQuestion() {
    validateEditQuestionInput(), $("#question_text, #question_answers_attributes_0_text").keyup(validateEditQuestionInput), selectQsetForNewQuestion(), $("#qset-id-input").change(function() {
        Cookies.set("new_question_qset_id", this.value, {
            expires: 1e3
        })
    })
}
...
function selectQsetForNewQuestion() {
    $(".qset-selectable").click(function() {
        $(".qset-display").text($(this).find(".qset-name-modal").data("qset-name")), $(".qset-display").removeClass("no-qset-chosen"), $("#qset-id-input").val($(this).find(".qset-name-modal").data("qset-id")).trigger("change"), $("#modal-launch").modal("hide"), validateEditQuestionInput()
    })
}

function initQsets() {
    $("#qsets").on("change", function() {
        var t = $(this.options[this.selectedIndex]);
        window.open(t.data("qset-url"), "_self")
    }), $(".modal").on("shown.bs.modal", function() {
        $(this).find("input:text:visible:first").focus().select()
    }), $("#modal-new-qset").on("show.bs.modal", function() {
        $(this).find('input[name="name"]').val(""), $(this).find('input[value="questions"]').prop("checked", !0), $(this).find('input[value="subsets"]').prop("checked", !1), $(this).find('input[value="mixed"]').prop("checked", !1)
    }), $("#modal-edit-qset").on("show.bs.modal", function() {
        $("#delete_confirmation_form_container").hide()
    }), $("#edit-qset-delete").on("click", function() {
...
function initQuestionDisplayModalForQuizAll() {
    var t = $("#question_display_Modal");
    $(".submit-answer").show(), $(".answer-text").val(""), $(".response, .answers").hide(), initAnswerButton(), initUserFeedbackQuizAll(), t.find(".modal-title").text(quizQuestions[quizAllIndex].text), t.find(".first-answer").text(quizQuestions[quizAllIndex].answers[0].text)
}

function initDataForQuizAll() {
    $(".feedback-alert").hide();
    var t = $("#qset-show-container").data("qset-id");
    questionJSON(t)
}
...
function initQuestionFilter() {
    ...
    function e(e) {
        var o = t(e);
        o || n(i[e]), $(".quiz-all").attr("disabled", !o), $(".no-questions").toggleClass("hidden", o), $(".my-question").toggleClass("hidden", "other" == e || !o), $(".other-question").toggleClass("hidden", "mine" == e || !o)
    }

    function n(t) {
        var e = t + ' <a href="/questions/new?qset=' + o + '">Create one now!</a>';
        $(".no-questions > p").html(e)
    }
    var i = {
        ...
        o = $("#qset-show-container").data("qset-id");
    e(Cookies.get("all_mine_other_filter") || "all"), $(".filter-choice").click(function() {
        var t = $(this).find("input")[0].getAttribute("name");
        e(t), Cookies.set("all_mine_other_filter", t, {
            expires: 1e3
        })
    })
}

function questionJSON(t) {
    $.getJSON("/qsets/" + t, {
        filter: Cookies.get("all_mine_other_filter")
    }, function(t) {
        quizQuestions = t, initQuestionDisplayModalForQuizAll()
    })
}
...
function initVote() {
    $(".upvote-button").click(function(t) {
        var e = $(t.target).closest(".upvote-button"),
            n = e.data("vote-qid");
        sendVote(n, "/upvote")
    }), $(".downvote-button").click(function(t) {
        var e = $(t.target).closest(".downvote-button"),
            n = e.data("vote-qid");
        sendVote(n, "/downvote")
    })
}! function(t, e) {
    ...
    function c(t, e, n, i) {
        if (oe.acceptData(t)) {
            var o, r, a = oe.expando,
                ...
                l = s ? oe.cache : t,
                u = s ? t[a] : t[a] && a;
            if (u && l[u] && (i || l[u].data) || void 0 !== n || "string" != typeof e) return u || (u = s ? t[a] = V.pop() || oe.guid++ : a), l[u] || (l[u] = s ? {} : {
                toJSON: oe.noop
            }), ("object" == typeof e || "function" == typeof e) && (i ? l[u] = oe.extend(l[u], e) : l[u].data = oe.extend(l[u].data, e)), r = l[u], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[oe.camelCase(e)] = n), "string" == typeof e ? (o = r[e], null == o && (o = r[oe.camelCase(e)])) : o = r, o
        }
    }
    ...
    function T(t, e) {
        if (1 === e.nodeType && oe.hasData(t)) {
            ...
            if (s) {
                ...
                for (n in s)
                    for (i = 0, o = s[n].length; o > i; i++) oe.event.add(e, n, s[n][i])
            }
    ...
    function E(t) {
        var e = he,
            n = Ze[t];
        return n || (n = k(t, e), "none" !== n && n || (Ke = (Ke || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (Ke[0].contentWindow || Ke[0].contentDocument).document, e.write(), e.close(), n = k(t, e), Ke.detach()), Ze[t] = n), n
    }
    ...
    function N(t, e) {
        for (var n, i, o, r = [], a = 0, s = t.length; s > a; a++) i = t[a], i.style && (r[a] = oe._data(i, "olddisplay"), n = i.style.display, e ? (r[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ne(i) && (r[a] = oe._data(i, "olddisplay", E(i.nodeName)))) : (o = Ne(i), (n && "none" !== n || !o) && oe._data(i, "olddisplay", o ? n : oe.css(i, "display"))));
    ...
    function A(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > r; r += 2) "margin" === n && (a += oe.css(t, n + Se[r], !0, o)), i ? ("content" === n && (a -= oe.css(t, "padding" + Se[r], !0, o)), "margin" !== n && (a -= oe.css(t, "border" + Se[r] + "Width", !0, o))) : (a += oe.css(t, "padding" + Se[r], !0, o), "padding" !== n && (a += oe.css(t, "border" + Se[r] + "Width", !0, o)));
        return a
    }
    ...
    function _(t, e, n) {
        ...
        })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = oe.css(t, "display"), c = "none" === u ? oe._data(t, "olddisplay") || E(t.nodeName) : u, "inline" === c && "none" === oe.css(t, "float") && (ne.inlineBlockNeedsLayout && "inline" !== E(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", ne.shrinkWrapBlocks() || d.always(function() {
        ...
        if (oe.isEmptyObject(f)) "inline" === ("none" === u ? E(t.nodeName) : u) && (p.display = u);
        else {
            ...
            for (i in f) a = L(h ? m[i] : 0, i, d), i in m || (m[i] = a.start, h && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function F(t, e) {
        var n, i, o, r, a;
        for (n in t)
            if (i = oe.camelCase(n), o = e[i], r = t[n], oe.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), a = oe.cssHooks[i], a && "expand" in a) {
    ...
    function H(t, e, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var e = hn || I(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(r);
        ...
        for (F(c, u.opts.specialEasing); a > r; r++)
            if (i = bn[r].call(u, t, c, u.opts)) return i;
    ...
    function z(t, e, n, i) {
        ...
        if (oe.isArray(e)) oe.each(e, function(e, o) {
            n || Vn.test(t) ? i(t, o) : z(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
        });
    ...
    oe.fn = oe.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || oe.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++)
            if (null != (o = arguments[s]))
                for (i in o) t = a[i], n = o[i], a !== n && (u && n && (oe.isPlainObject(n) || (e = oe.isArray(n))) ? (e ? (e = !1, r = t && oe.isArray(t) ? t : []) : r = t && oe.isPlainObject(t) ? t : {}, a[i] = oe.extend(u, r, n)) : void 0 !== n && (a[i] = n));
        return a
    }, oe.extend({
        ...
        proxy: function(t, e) {
            var n, i, o;
            return "string" == typeof e && (o = t[e], e = t, t = o), oe.isFunction(t) ? (n = J.call(arguments, 2), i = function() {
    ...
    var ue = function(t) {
        function e(t, e, n, i) {
            ...
            if ((e ? e.ownerDocument || e : P) !== q && j(e), e = e || q, n = n || [], !t || "string" != typeof t) return n;
            ...
            if (O && !i) {
                ...
                if (w.qsa && (!L || !L.test(t))) {
                    if (p = d = R, h = e, m = 9 === s && t, 1 === s && "object" !== e.nodeName.toLowerCase()) {
                        for (u = E(t), (d = e.getAttribute("id")) ? p = d.replace(xe, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = u.length; l--;) u[l] = p + f(u[l]);
        ...
        function p(t, e, n) {
            ...
            return e.first ? function(e, n, r) {
                ...
                if (a) {
                    ...
                    for (; e = e[i];)
                        if (1 === e.nodeType || o) {
                            if (l = e[R] || (e[R] = {}), (s = l[i]) && s[0] === M && s[1] === r) return u[2] = s[2];
            ...
            return o && !o[R] && (o = v(o)), r && !r[R] && (r = v(r, a)), i(function(i, a, s, l) {
                ...
                if (i) {
                    if (r || t) {
                        ...
                        for (c = b.length; c--;)(d = b[c]) && (u = r ? ee.call(i, d) : f[c]) > -1 && (i[u] = !(a[u] = d))
                    }
        ...
        function y(t) {
            for (var e, n, i, o = t.length, r = T.relative[t[0].type], a = r || T.relative[" "], s = r ? 1 : 0, l = p(function(t) {
                ...
                if (n = T.relative[t[s].type]) c = [p(h(c), n)];
                else {
                    if (n = T.filter[t[s].type].apply(null, t[s].matches), n[R]) {
                        ...
                        return v(s > 1 && h(c), s > 1 && f(t.slice(0, s - 1).concat({
                            value: " " === t[s - 2].type ? "*" : ""
                        })).replace(le, "$1"), n, i > s && y(t.slice(s, i)), o > i && y(t = t.slice(i)), o > i && f(t))
                    }
                    c.push(n)
                }
            return h(c)
            ...
            var o = n.length > 0,
                ...
                a = function(i, a, s, l, u) {
                    var c, d, f, p = 0,
                        ...
                        w = b.length;
                    for (u && (N = a !== q && a); h !== w && null != (c = b[h]); h++) {
                        if (r && c) {
                            for (d = 0; f = t[d++];)
                                if (f(c, a, s)) {
                                    l.push(c);
        ...
        var x, w, T, C, k, E, $, S, N, D, A, j, q, I, O, L, _, F, H, R = "sizzle" + -new Date,
            P = t.document,
            M = 0,
            B = 0,
            W = n(),
        ...
        w = e.support = {}, k = e.isXML = function(t) {
            ...
            var e, n = t ? t.ownerDocument || t : P,
                i = n.defaultView;
            return n !== q && 9 === n.nodeType && n.documentElement ? (q = n, I = n.documentElement, O = !k(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                j()
                ...
                return I.appendChild(t).id = R, !n.getElementsByName || !n.getElementsByName(R).length
            ...
            }, _ = [], L = [], (w.qsa = ve.test(n.querySelectorAll)) && (o(function(t) {
            ...
            })), (w.matchesSelector = ve.test(F = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function(t) {
                w.disconnectedMatch = F.call(t, "div"), F.call(t, "[s!='']:x"), _.push("!=", se)
            }), L = L.length && new RegExp(L.join("|")), _ = _.length && new RegExp(_.join("|")), e = ve.test(I.compareDocumentPosition), H = e || ve.test(I.contains) ? function(t, e) {
                ...
                return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === P && H(P, t) ? -1 : e === n || e.ownerDocument === P && H(P, e) ? 1 : D ? ee.call(D, t) - ee.call(D, e) : 0 : 4 & i ? -1 : 1)
            } : function(t, e) {
                if (t === e) return A = !0, 0;
                var i, o = 0,
                    r = t.parentNode,
                ...
                for (; l[o] === u[o];) o++;
                return o ? a(l[o], u[o]) : l[o] === P ? -1 : u[o] === P ? 1 : 0
            }, n) : q
        }, e.matches = function(t, n) {
            return e(t, null, null, n)
        }, e.matchesSelector = function(t, n) {
            if ((t.ownerDocument || t) !== q && j(t), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !O || _ && _.test(n) || L && L.test(n))) try {
                var i = F.call(t, n);
                if (i || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return i
            } catch (o) {}
            return e(n, q, null, [t]).length > 0
        }, e.contains = function(t, e) {
            return (t.ownerDocument || t) !== q && j(t), H(t, e)
        }, e.attr = function(t, e) {
            (t.ownerDocument || t) !== q && j(t);
            var n = T.attrHandle[e.toLowerCase()],
                i = n && J.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !O) : void 0;
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return he.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && fe.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function(t) {
                    ...
                    return 1 === i && 0 === o ? function(t) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[R] || (g[R] = {}), u = c[t] || [], p = u[0] === M && u[1], f = u[0] === M && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++f && d === e) {
                                        c[t] = [M, p, f];
                                        break
                                    }
                            } else if (y && (u = (e[R] || (e[R] = {}))[t]) && u[0] === M) f = u[1];
                            else
                                for (;
                                    (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[R] || (d[R] = {}))[t] = [M, f]), d !== e)););
                ...
                PSEUDO: function(t, n) {
                    ...
                    return r[R] ? r(n) : r.length > 1 ? (o = [t, t, "", n], T.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, E = e.tokenize = function(t, n) {
            ...
            for (s = t, l = [], u = T.preFilter; s;) {
                ...
                for (a in T.filter) !(o = he[a].exec(s)) || u[a] && !(o = u[a](o)) || (i = o.shift(), r.push({
                    value: i,
                    type: a,
                    matches: o
                }), s = s.slice(i.length));
            ...
            if (n = n || [], 1 === d.length) {
                if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (a = r[0]).type && w.getById && 9 === e.nodeType && O && T.relative[r[1].type]) {
            ...
            return (u || $(t, d))(i, e, !O, n, be.test(t) && c(e.parentNode) || e), n
        }, w.sortStable = R.split("").sort(Q).join("") === R, w.detectDuplicates = !!A, j(), w.sortDetached = o(function(t) {
    ...
    oe.Callbacks = function(t) {
            ...
            d = {
                ...
                remove: function() {
                    return l && oe.each(arguments, function(t, n) {
                        for (var i;
                            (i = oe.inArray(n, l, i)) > -1;) l.splice(i, 1), e && (o >= i && o--, a >= i && a--)
                    }), this
                },
                has: function(t) {
        ...
        when: function(t) {
            var e, n, i, o = 0,
                ...
                u = function(t, n, i) {
                    return function(o) {
                        n[t] = this, i[t] = arguments.length > 1 ? J.call(arguments) : o, i === e ? l.notifyWith(n, i) : --s || l.resolveWith(n, i)
                    }
                };
            if (a > 1)
                for (e = new Array(a), n = new Array(a), i = new Array(a); a > o; o++) r[o] && oe.isFunction(r[o].promise) ? r[o].promise().done(u(o, i, r)).fail(l.reject).progress(u(o, n, e)) : --s;
    ...
    oe.event = {
        ...
        add: function(t, e, n, i, o) {
            var r, a, s, l, u, c, d, f, p, h, m, g = oe._data(t);
            if (g) {
                for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = oe.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                    ...
                    }, c.elem = t), e = (e || "").match(be) || [""], s = e.length; s--;) r = Le.exec(e[s]) || [], p = m = r[1], h = (r[2] || "").split(".").sort(), p && (u = oe.event.special[p] || {}, p = (o ? u.delegateType : u.bindType) || p, u = oe.event.special[p] || {}, d = oe.extend({
                    type: p,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, l), (f = a[p]) || (f = a[p] = [], f.delegateCount = 0, u.setup && u.setup.call(t, i, h, c) !== !1 || (t.addEventListener ? t.addEventListener(p, c, !1) : t.attachEvent && t.attachEvent("on" + p, c))), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, d) : f.push(d), oe.event.global[p] = !0);
                t = null
            }
        },
        remove: function(t, e, n, i, o) {
            var r, a, s, l, u, c, d, f, p, h, m, g = oe.hasData(t) && oe._data(t);
            if (g && (c = g.events)) {
                for (e = (e || "").match(be) || [""], u = e.length; u--;)
                    if (s = Le.exec(e[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (d = oe.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, f = c[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = f.length; r--;) a = f[r], !o && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (f.splice(r, 1), a.selector && f.delegateCount--, d.remove && d.remove.call(t, a));
                        l && !f.length && (d.teardown && d.teardown.call(t, h, g.handle) !== !1 || oe.removeEvent(t, p, g.handle), delete c[p])
                    } else
        ...
        trigger: function(e, n, i, o) {
            var r, a, s, l, u, c, d, f = [i || he],
                p = ee.call(e, "type") ? e.type : e,
                h = ee.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = c = i = i || he, 3 !== i.nodeType && 8 !== i.nodeType && !Oe.test(p + oe.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, e = e[oe.expando] ? e : new oe.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : oe.makeArray(n, [e]), u = oe.event.special[p] || {}, o || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                if (!o && !u.noBubble && !oe.isWindow(i)) {
                    for (l = u.delegateType || p, Oe.test(l + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), c = s;
                    c === (i.ownerDocument || he) && f.push(c.defaultView || c.parentWindow || t)
                }
                for (d = 0;
                    (s = f[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : u.bindType || p, r = (oe._data(s, "events") || {})[e.type] && oe._data(s, "handle"), r && r.apply(s, n), r = a && s[a], r && r.apply && oe.acceptData(s) && (e.result = r.apply(s, n), e.result === !1 && e.preventDefault());
                if (e.type = p, !o && !e.isDefaultPrevented() && (!u._default || u._default.apply(f.pop(), n) === !1) && oe.acceptData(i) && a && i[p] && !oe.isWindow(i)) {
            ...
            if (s[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                for (a = oe.event.handlers.call(this, t, l), e = 0;
                    ...
                    for (t.currentTarget = o.elem, r = 0;
                        (i = o.handlers[r++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(i.namespace)) && (t.handleObj = i, t.data = i.data, n = ((oe.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, s), void 0 !== n && (t.result = n) === !1 && (t.preventDefault(), t.stopPropagation()));
        ...
        fix: function(t) {
            ...
            var e, n, i, o = t.type,
                r = t,
                a = this.fixHooks[o];
            for (a || (this.fixHooks[o] = a = Ie.test(o) ? this.mouseHooks : qe.test(o) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, t = new oe.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
        ...
        return this instanceof oe.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? f : p) : this.type = t, e && oe.extend(this, e), this.timeStamp = t && t.timeStamp || oe.now(), void(this[oe.expando] = !0)) : new oe.Event(t, e)
    }, oe.Event.prototype = {
    ...
    Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, oe.extend({
        clone: function(t, e, n) {
            ...
            if (ne.html5Clone || oe.isXMLDoc(t) || !He.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Ge.innerHTML = t.outerHTML, Ge.removeChild(r = Ge.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || oe.isXMLDoc(t)))
        ...
        buildFragment: function(t, e, n, i) {
            for (var o, r, a, s, l, u, c, d = t.length, f = m(e), p = [], h = 0; d > h; h++)
                ...
                for (s = s || f.appendChild(e.createElement("div")), l = (Me.exec(r) || ["", ""])[1].toLowerCase(), c = Je[l] || Je._default, s.innerHTML = c[1] + r.replace(Pe, "<$1></$2>") + c[2], o = c[0]; o--;) s = s.lastChild;
                if (!ne.leadingWhitespace && Re.test(r) && p.push(e.createTextNode(Re.exec(r)[0])), !ne.tbody)
                    for (r = "table" !== l || Be.test(r) ? "<table>" !== c[1] || Be.test(r) ? 0 : s : s.firstChild, o = r && r.childNodes.length; o--;) oe.nodeName(u = r.childNodes[o], "tbody") && !u.childNodes.length && r.removeChild(u);
                for (oe.merge(p, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = f.lastChild
            } else p.push(e.createTextNode(r));
            for (s && f.removeChild(s), ne.appendChecked || oe.grep(g(p, "input"), v), h = 0; r = p[h++];)
                if ((!i || -1 === oe.inArray(r, i)) && (a = oe.contains(r.ownerDocument, r), s = g(f.appendChild(r), "script"), a && w(s), n))
        ...
        html: function(t) {
            return De(this, function(t) {
                ...
                if (!("string" != typeof t || ze.test(t) || !ne.htmlSerialize && He.test(t) || !ne.leadingWhitespace && Re.test(t) || Je[(Me.exec(t) || ["", ""])[1].toLowerCase()])) {
                    t = t.replace(Pe, "<$1></$2>");
                    try {
        ...
        domManip: function(t, e) {
            ...
            var n, i, o, r, a, s, l = 0,
                ...
                f = t[0],
                p = oe.isFunction(f);
            if (p || u > 1 && "string" == typeof f && !ne.checkClone && Ue.test(f)) return this.each(function(n) {
                var i = c.eq(n);
            ...
            if (u && (s = oe.buildFragment(t, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                ...
                if (o)
                    for (a = r[r.length - 1].ownerDocument, oe.map(r, x), l = 0; o > l; l++) i = r[l], Qe.test(i.type || "") && !oe._data(i, "globalEval") && oe.contains(a, i) && (i.src ? oe._evalUrl && oe._evalUrl(i.src) : oe.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Ve, "")));
                s = n = null
            }
            return this
        }
        ...
        oe.fn[t] = function(t) {
            for (var n, i = 0, o = [], r = oe(t), a = r.length - 1; a >= i; i++) n = i === a ? this : this.clone(!0), oe(r[i])[e](n), G.apply(o, n.get());
    ...
    t.getComputedStyle ? (tn = function(t) {
        ...
        function() {
            function e() {
                var e, n, i, o;
                n = he.getElementsByTagName("body")[0], n && n.style && (e = he.createElement("div"), i = he.createElement("div"), i.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(i).appendChild(e), e.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", r = a = !1, l = !0, t.getComputedStyle && (r = "1%" !== (t.getComputedStyle(e, null) || {}).top, a = "4px" === (t.getComputedStyle(e, null) || {
                    width: "4px"
    ...
    oe.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, a, s = oe.camelCase(e),
                    l = t.style;
                if (e = oe.cssProps[s] || (oe.cssProps[s] = S(l, s)), a = oe.cssHooks[e] || oe.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(t, !1, i)) ? o : l[e];
        ...
        css: function(t, e, n, i) {
            var o, r, a, s = oe.camelCase(e);
            return e = oe.cssProps[s] || (oe.cssProps[s] = S(t.style, s)), a = oe.cssHooks[e] || oe.cssHooks[s], a && "get" in a && (r = a.get(t, !0, n)), void 0 === r && (r = en(t, e, i)), "normal" === r && e in fn && (r = fn[e]), "" === n || n ? (o = parseFloat(r), n === !0 || oe.isNumeric(o) ? o || 0 : r) : r
        }
        ...
        run: function(t) {
            ...
            return this.pos = e = this.options.duration ? oe.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : q.propHooks._default.set(this), this
        }
    ...
    var Tn, Cn, kn = oe.expr.attrHandle,
    ...
    oe.fn.extend({
        ...
        removeAttr: function(t, e) {
            var n, i, o = 0,
                r = e && e.match(be);
            if (r && 1 === t.nodeType)
                for (; n = r[o++];) i = oe.propFix[n] || n, oe.expr.match.bool.test(n) ? Sn && $n || !En.test(n) ? t[i] = !1 : t[oe.camelCase("default-" + n)] = t[i] = !1 : oe.attr(t, n, ""), t.removeAttribute($n ? n : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        set: function(t, e, n) {
            return e === !1 ? oe.removeAttr(t, n) : Sn && $n || !En.test(n) ? t.setAttribute(!$n && oe.propFix[n] || n, n) : t[oe.camelCase("default-" + n)] = t[n] = !0, n
        }
    }, oe.each(oe.expr.match.bool.source.match(/\w+/g), function(t, e) {
        var n = kn[e] || oe.find.attr;
        kn[e] = Sn && $n || !En.test(e) ? function(t, e, i) {
            var o, r;
            return i || (r = kn[e], kn[e] = o, o = null != n(t, e, i) ? e.toLowerCase() : null, kn[e] = r), o
        } : function(t, e, n) {
    ...
    oe.parseJSON = function(e) {
        ...
        var n, i = null,
            o = oe.trim(e + "");
        return o && !oe.trim(o.replace(In, function(t, e, o, r) {
    ...
    On = Bn.exec(Ln.toLowerCase()) || [], oe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, e) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || Ln) + "").replace(_n, "").replace(Mn, On[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = oe.trim(d.dataType || "*").toLowerCase().match(be) || [""], null == d.crossDomain && (i = Bn.exec(d.url.toLowerCase()), d.crossDomain = !(!i || i[1] === On[1] && i[2] === On[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (On[3] || ("http:" === On[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = oe.param(d.data, d.traditional)), P(Wn, d, e, w), 2 === b) return w;
            l = d.global, l && 0 === oe.active++ && oe.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Pn.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (qn.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Fn.test(r) ? r.replace(Fn, "$1_=" + jn++) : r + (qn.test(r) ? "&" : "?") + "_=" + jn++)), d.ifModified && (oe.lastModified[r] && w.setRequestHeader("If-Modified-Since", oe.lastModified[r]), oe.etag[r] && w.setRequestHeader("If-None-Match", oe.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Un + "; q=0.01" : "") : d.accepts["*"]);
    ...
    oe.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !oe(this).is(":disabled") && Gn.test(this.nodeName) && !Yn.test(t) && (this.checked || !Ae.test(t))
            }).map(function(t, e) {
                var n = oe(this).val();
    ...
    oe.ajaxSetup({
        ...
        return s || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = oe.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(ni, "$1" + o) : e.jsonp !== !1 && (e.url += (qn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
    ...
    oe.fn.load = function(t, e, n) {
        ...
        var i, o, r, a = this,
            s = t.indexOf(" ");
        return s >= 0 && (i = oe.trim(t.slice(s, t.length)), t = t.slice(0, s)), oe.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), a.length > 0 && oe.ajax({
            url: t,
            type: r,
            dataType: "html",
            data: e
    ...
    oe.offset = {
        setOffset: function(t, e, n) {
            var i, o, r, a, s, l, u, c = oe.css(t, "position"),
                d = oe(t),
                f = {};
            "static" === c && (t.style.position = "relative"), s = d.offset(), r = oe.css(t, "top"), l = oe.css(t, "left"), u = ("absolute" === c || "fixed" === c) && oe.inArray("auto", [r, l]) > -1, u ? (i = d.position(), a = i.top, o = i.left) : (a = parseFloat(r) || 0, o = parseFloat(l) || 0), oe.isFunction(e) && (e = e.call(t, n, s)), null != e.top && (f.top = e.top - s.top + a), null != e.left && (f.left = e.left - s.left + o), "using" in e ? e.using.call(t, f) : d.css(f)
        }
    }, oe.fn.extend({
        offset: function(t) {
            ...
            var e, n, i = {
                ...
                o = this[0],
                r = o && o.ownerDocument;
            if (r) return e = r.documentElement, oe.contains(e, o) ? (typeof o.getBoundingClientRect !== Ce && (i = o.getBoundingClientRect()), n = X(r), {
    ...
    function e(n) {
        function i(e, o, r) {
            ...
            for (var u = document.cookie ? document.cookie.split("; ") : [], c = /(%[0-9A-Z]{2})+/g, d = 0; d < u.length; d++) {
                ...
                try {
                    if (h = n && n(h, p) || h.replace(c, decodeURIComponent), this.json) try {
                        h = JSON.parse(h)
                    } catch (l) {}
                    if (e === p) {
                        a = h;
    ...
    n.VERSION = "3.3.2", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (u) {
                ...
                s = "bottom" == s && c.bottom + f > m.bottom ? "top" : "top" == s && c.top - f < m.top ? "bottom" : "right" == s && c.right + d > m.width ? "left" : "left" == s && c.left - d < m.left ? "right" : s, r.re
                moveClass(p).addClass(s)
            }
            var g = this.getCalculatedOffset(s, c, d, f);
